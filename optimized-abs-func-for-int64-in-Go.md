---
title: 在 Golang 中针对 int64 类型优化 abs()
date: 2018-02-07 22:22:12
tags: Golang
---
...
这是我加入 GCTT 后参与翻译的第一篇文章，感谢原作者 [Ryan Armstrong](http://cavaliercoder.com/)。学习到了测试用例的写法，基准测试的正确用法等等，以后争取每周翻译一篇高质量博客 :-D
